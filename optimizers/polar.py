...
Single shared implementation of the Newton-Schulz polar decomposition
used by both Aurora and NF-Aurora optimizers.
"""
...
def polar_compiled(G: torch.Tensor, steps: int = 12, eps: float = 1e-7) -> torch.Tensor:
    """torch.compile'd variant for use in NF-Aurora's hot path.
